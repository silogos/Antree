 ...
 */
export function logQuery(query: string, duration: number, extra?: Record<string, unknown>) {
  logger.debug(
    {
      action: "db_query",
 ...
 * Log SSE events
 */
export function logSSEEvent(eventType: string, sessionId: string, extra?: Record<string, unknown>) {
  logger.debug(
    {
      action: "sse_event",
      eventType,
