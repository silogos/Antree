    ...
    if (error instanceof AppError) {
      ...
      switch (error.type) {
        ...
        case ErrorType.NotFound:
          response = errorResponse(ErrorCode.NOT_FOUND, error.message, requestId, error.details);
          break;
        case ErrorType.Conflict:
          response = errorResponse(ErrorCode.CONFLICT, error.message, requestId, error.details);
          break;
