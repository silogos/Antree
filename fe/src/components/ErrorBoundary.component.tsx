          ...
          <div className="max-w-md rounded-lg bg-white p-8 shadow-lg">
            ...
            {process.env.NODE_ENV === "development" && this.state.error?.stack && (
              <details className="mb-6 rounded-md bg-gray-100 p-4 text-sm">
                ...
                <pre className="overflow-auto text-xs text-gray-800">{this.state.error.stack}</pre>
              </details>
            )}
...
export function ErrorFallback({ error, resetError, className = "", ...props }: ErrorFallbackProps) {
  return (
    <div className={`flex items-center justify-center bg-red-50 p-4 ${className}`} {...props}>
